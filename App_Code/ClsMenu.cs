...
public class ClsMenu
{
    ...
    public void getMenu(Menu NavigationMenu) {
     if (HttpContext.Current.User.Identity.IsAuthenticated)
        {
            MenuItem itemMember = new MenuItem("Member");
            itemMember.Selectable = false;
            NavigationMenu.Items.AddAt(1, itemMember);

            MenuItem itemMemberHome = new MenuItem("Member Home");
            itemMemberHome.NavigateUrl = "Member.aspx";
            itemMember.ChildItems.Add(itemMemberHome);
        ...
        if (!ClsConfig.requireLogin() || HttpContext.Current.User.Identity.IsAuthenticated)
        {
            ...
            itemTest22.SeparatorImageUrl = ResolveUrl("~/images/MenuSeparator.jpg"); // Menu Separator.
                ...
                Roles.IsUserInRole(HttpContext.Current.User.Identity.Name, "Administrator"))
            {
                ...
                //itemNewUser.SeparatorImageUrl = ResolveUrl("~/images/MenuSeparator.jpg"); // Menu Separator.
